...
public class EventDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate (SQLiteDatabase db) {
        ...
        String CREATE_EVENTS_TABLE = "CREATE TABLE " +
                ...
                DataBaseSchema.EventsTable.COLUMN_NAME + " TEXT," +
                DataBaseSchema.EventsTable.COLUMN_DESCRIPTION + " TEXT, " +
                DataBaseSchema.EventsTable.COLUMN_DURATION + " INTEGER," +
                DataBaseSchema.EventsTable.COLUMN_COMPLETED + " BOOL " +
                ")";
